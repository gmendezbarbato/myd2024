...
setwd("C:/Usuario/User/Desktop/cursos/Medicion y diseño/carpeta_del_curso") 
```
...
RStudio tiene una solución mucho más eficiente para setear directorios de trabajo: **Proyectos**

Los proyectos se guardan en una carpeta en un archivo .Rproj

De manera simplificada, lo que hace es setear una carpeta. Por lo cual, al abrir ese archivo de proyecto, RStudio "ya sabe" que estamos trabajando en ese directorio y no tenemos que escirbir la ruta.
...
En la computadora en la que estés trabajando, en la carpeta creada, crea un proyecto.
...
- El paquete rio permite importar, exportar y convertir datos desde y hacia diferentes formatos de manera más óptima.

- Las funciones import() y export() facilitan la tarea y hacen más intuitivo el proceso.

- En realidad lo que hace rio() es emnascarar en un paquete muchas funciones de los paquetes de importación que vimos anteriormente.
